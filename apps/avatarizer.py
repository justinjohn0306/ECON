...
econ_obj.export(f"{prefix}/econ_raw.ply")
...
if not osp.exists(f"{prefix}/econ_da.obj") or not osp.exists(f"{prefix}/smpl_da.obj"):
    ...
    econ_da = poisson(econ_da, f"{prefix}/econ_da.obj", depth=10, face_count=1e5)
    econ_da = remesh_laplacian(econ_da, f"{prefix}/econ_da.obj")
else:
